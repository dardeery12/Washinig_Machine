...
Machine_Mode_t G_Machine_Current_Mode = ERROR_CHOOSE_MODE;/*macine mode manual or automatic */
...
Std_ReturnType Machine_Lcd()
{
	...
	case MANUAL_MODE:
	{
		...
		{
			G_Alarm_Notification= E_OK;
			lcd_4bit_send_string_pos(&lcd1,1,1,"alarm");
		}
	}
	break;
